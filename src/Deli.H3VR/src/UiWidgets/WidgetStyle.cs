...
namespace Deli.H3VR.UiWidgets
{
	...
	public class WidgetStyle : MonoBehaviour
	{
		...
		public Sprite ButtonSprite { get; set; } = DefaultButtonSprite is not null && DefaultButtonSprite ? DefaultButtonSprite : throw new InvalidOperationException("Default text font was null!");
