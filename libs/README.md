...
1. Download `mono-cil-strip`  
  ...
  - For Linux developers, this may be present in your distribution's Mono package  
    - Arch Linux: `mono`
2. Drag the original `Assembly-CSharp.dll` onto it
...
2. Run `MonoMod.RuntimeDetour.HookGen.exe --private [PATH TO Assembly-CSharp.dll]` within the temporary directory
